...
//     console.log('🔍 Searching for fire stations at camera location...');
//     console.log('📍 Camera Location:', latitude, longitude);
...
//     if (data.status === 'ZERO_RESULTS' || !data.results || data.results.length === 0) {
//       if (radius < 10000) {
//         console.log('No results found, expanding search radius to 10km...');
//         return fetchNearbyFireStations(latitude, longitude, 10000);
//       }
//       return [];
//     }
...
// // Fallback function to generate mock data based on camera location (if API fails)
// const generateFallbackStations = (cameraLat: number, cameraLng: number): FireStation[] => {
//   const stations: FireStation[] = [];
//   const radiusKm = 5;
...
//     const latOffset = (distance * Math.cos(angle)) / 111;
//     const lngOffset = (distance * Math.sin(angle)) / (111 * Math.cos(cameraLat * Math.PI / 180));

//     stations.push({
//       id: `fallback-${i}`,
//       name: `Fire Station ${i + 1}`,
//       address: `Near camera location ${i + 1}`,
//       phone: '+63 XXX-XXX-XXXX',
//       latitude: cameraLat + latOffset,
//       longitude: cameraLng + lngOffset,
//       rating: 4.0 + Math.random() * 1.0,
//       isOpen: Math.random() > 0.3
//     });
//   }
...
//   // Load fire stations on mount using fixed camera location
//   useEffect(() => {
//     loadFireStations();
//   }, []);
...
//     console.log("📍 Using fixed camera location:", CAMERA_LOCATION);

//     try {
//       const nearbyStations = await fetchNearbyFireStations(
...
//       <View style={styles.loadingContainer}>
//         <Ionicons name="locate" size={64} color="#FF4444" />
//         <Text style={styles.loadingText}>Finding fire stations near camera</Text>
//         {/* <Text style={styles.locationSubtext}>
//           📍 {CAMERA_LOCATION.latitude.toFixed(6)}, {CAMERA_LOCATION.longitude.toFixed(6)}
//         </Text> */}
//       </View>
//     );
//   }
...
//               </Text>
//               {/* <Text style={styles.locationSubtext}>
//                 📍 Camera: {CAMERA_LOCATION.latitude.toFixed(6)}, {CAMERA_LOCATION.longitude.toFixed(6)}
//               </Text> */}
//             </View>
//           </View>
//           <TouchableOpacity style={styles.refreshButton} onPress={handleRefreshLocation}>
...
//         {/* MapView - centered on camera location */}
//         <MapView
//           style={styles.map}
//           initialRegion={{
...
//             <View style={styles.noStationsContainer}>
//               <Ionicons name="alert-circle-outline" size={48} color="#999" />
//               <Text style={styles.noStationsText}>No fire stations found within 5km radius of camera location</Text>
//               <TouchableOpacity style={styles.retryButton} onPress={handleRefreshLocation}>
//                 <Text style={styles.retryButtonText}>Try Again</Text>
//               </TouchableOpacity>
//             </View>
